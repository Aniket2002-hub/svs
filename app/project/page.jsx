...
const logos = [
    ...
    {/* Hero Section */}
      ...
      >
        <div className="relative z-10 max-w-5xl mx-auto ">
          <h2 data-aos="slide-right" data-aos-duration="1500" className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6">Belmond</h2>
      </div>
      </div>

      {/* Collaborations Section */}
      <section data-aos="fade-left" className="py-16 px-4 md:px-12 max-w-7xl mx-auto">
        ...
        <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-10">
          Over the years, we have successfully delivered a series of landmark
          projects that redefine excellence in real estate. Each development
          stands as a testament to our commitment to quality, innovation, and
          timely execution. From premium residential communities to
          state-of-the-art commercial spaces, our projects have not only met but
          exceeded customer expectations. With a focus on superior construction,
          prime locations, and modern amenities, we have transformed aspirations
          into reality. Our track record of delivering on promises has earned us
          the trust of homebuyers and investors alike, reinforcing our position
  ...
  <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center relative z-10 gap-12">
    ...
    <div className="text-gray-800 max-w-xl ml-0 lg:ml-4 text-center lg:text-left">
      ...
      <p className="text-gray-600 mb-6 leading-relaxed">
        Our upcoming Open plots offering, Belmond at Rajapulova junction, Vizag is the
        gateway to a world of potential, beauty, and limitless opportunities. Each plot
        holds the promise of transformation and the fulfilment of your dreams.
      </p>
  ...
  <div className="max-w-5xl mx-auto px-4">
    <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-0 text-lg font-medium text-gray-800">
      <div className="md:w-1/3 text-center"><span>Project Size: </span>12.35 Acres</div>

      <div className="hidden md:block w-px h-6 bg-gray-400 mx-4"></div>

      <div className="md:w-1/3 text-center"><span>Total:  </span>175 Units</div>

      <div className="hidden md:block w-px h-6 bg-gray-400 mx-4"></div>

      <div className="md:w-1/3 text-center"><span className='text-bold'>Plot Range:  </span>129 to 655 Sq. Yds</div>
    </div>
  </div>
  ...
  <div className="max-w-5xl mx-auto px-4 mt-10">
    ...
    >
      {[
        { src: "/Assets/AVENUE PARK.jpg", label: "Avenue Plantation", icon: "🌴" },
        { src: "/Assets/STREET LIGHTS.jpg", label: "Street Lights", icon: "💡" },
        { src: "/Assets/ELDERS PARK.jpg", label: "Elders Park", icon: "🧓" },
        { src: "/Assets/CHLIDREN PARK.jpg", label: "Children Park", icon: "🧒" },
      ].map((item, index) => (
        <SwiperSlide key={index}>
          <div className="relative w-full h-full">
            ...
            <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 text-white text-sm px-3 py-1 rounded">
              <span className="inline-block mr-2">{item.icon}</span> {item.label}
            </div>
          </div>
        </SwiperSlide>
      ))}
      ...
      {/* === Amenity Icons Grid === */}
     <h2 className="text-3xl font-semibold mt-5 mb-4 text-gray-800 text-center">Amenities</h2>
    ...
    >
      ...
      <section className="bg-[#f6f6f6] py-12 px-4 mt-20">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 mb-8">Location</h2>
         ...
         <section className="bg-[#f6f6f6] py-12 px-4 mt-20">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 mb-8">Layout</h2>
